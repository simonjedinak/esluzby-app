  ...
  sendMail({
    ...
    html: `
        <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto;">
          ...
          <p style="margin: 16px 0;">Prihláste sa na: <a href="https://ejano.vercel.app/" style="color:#1d4ed8; text-decoration:none;">https://www.ejano.vercel.app</a></p>
          <p style="text-align:center; margin: 12px 0;"><a href="https://ejano.vercel.app/" style="background:#1d4ed8;color:#fff;padding:10px 16px;border-radius:6px;text-decoration:none;display:inline-block;">Prihlásiť sa</a></p>
